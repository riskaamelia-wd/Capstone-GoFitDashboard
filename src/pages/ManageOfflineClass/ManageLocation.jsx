...
const handleDelete = async (id) => {
  await adminApi.delete(`/admin/locations/${id}`, null, config).then(() => {
  fetchData();
  ...
  <>
    ...
    <Row>
        <Col md={12} className="mt-4 mb-2 d-flex flex-row justify-content-between">
            <p style={{color:'var(--Neutral-Black-100)', fontSize:'28px', fontWeight:'700'}} className="p-0 m-0">Location</p>
